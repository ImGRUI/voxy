...
public abstract class VoxyConfigScreenPages {
    ...
    public static OptionPage page() {
        ...
        groups.add(OptionGroup.createBuilder()
                        .add(OptionImpl.createBuilder(boolean.class, storage)
                                .setName(Component.translatable("voxy.config.general.save_flashback"))
                                .setTooltip(Component.translatable("voxy.config.general.save_flashback.tooltip"))
                                .setControl(TickBoxControl::new)
        ...
        groups.add(OptionGroup.createBuilder()
                        .add(OptionImpl.createBuilder(boolean.class, storage)
                                ...
                                .setName(Component.translatable("voxy.config.general.fix_nether_fog"))
                                .setTooltip(Component.translatable("voxy.config.general.fix_nether_fog.tooltip"))
                                .setControl(TickBoxControl::new)
                                .setBinding((s, v)-> s.fixNetherFog = v, s -> s.fixNetherFog)
                                .setFlags(OptionFlag.REQUIRES_RENDERER_RELOAD)
                                .build()
                        ).add(OptionImpl.createBuilder(boolean.class, storage)
                                .setName(Component.translatable("voxy.config.general.customfog"))
                                .setTooltip(Component.translatable("voxy.config.general.customfog.tooltip"))
                                .setControl(TickBoxControl::new)
                                .setBinding((s, v)-> s.customFog = v, s -> s.customFog)
                                .setFlags(OptionFlag.REQUIRES_RENDERER_RELOAD)
                                .build()
                        ).add(OptionImpl.createBuilder(int.class, storage)
                                .setName(Component.translatable("voxy.config.general.customfog_env"))
                                .setTooltip(Component.translatable("voxy.config.general.customfog_env.tooltip"))
                                .setControl(opt->new SliderControl(opt, 10, 1000, 10, v->Component.literal(Integer.toString(v))))
                                .setBinding((s, v)-> s.environmentalEnd = v, s -> s.environmentalEnd)
                                .build()
                        ).build()
        );
